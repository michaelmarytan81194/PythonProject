...
/****** Object:  StoredProcedure [dbo].[AD_BIGCONTRACT_BUDGET_BONUS]    Script Date: 01-Apr-2024 2:32:58 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE   PROCEDURE [dbo].[AD_BIGCONTRACT_BUDGET_BONUS] (@varREPORT_MONTH nvarchar(4000)) 
AS 
BEGIN
...
, BIG_CONTRACT_DETAIL AS (
	SELECT
		*
	FROM [DP_Tan].[dbo].[T_BIG_CONTRACT_BUDGET_DETAIL]
...
, A AS (
	SELECT
		...
		ROUND(CAST(SUM([IP_COUNT_BONUS_FINAL]) AS bigint), 0) AS IP_DAT_THUONG,
